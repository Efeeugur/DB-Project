...
public class AttendancePanel extends JPanel {
    ...
    private JPanel createSelectionPanel() {
        ...
        JLabel step1 = new JLabel("1. Select Course:");
        ...
        JLabel step2 = new JLabel("2. Select Session:");
        ...
        JLabel step3 = new JLabel("3. Open Attendance Sheet:");
        ...
        JLabel infoLabel = new JLabel(
                "<html><i>Select a course and session, then<br>take attendance for all students at once!</i></html>");
    ...
    private void refreshTable() {
        ...
        String sessionTopic = sessionSelected.contains("(")
                ? sessionSelected.substring(sessionSelected.indexOf("(") + 1, sessionSelected.length() - 1)
                : "Session";
